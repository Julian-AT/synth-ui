...
2. **"inquire"**: Use this option if you cannot reasonably generate a component with the information provided. It should be used when essential details are missing, and there is no feasible way to proceed without clarification.  
